                                  ...
                                  ?>
                                    <tbody id="table">
                                      <tr>
                                          ...
                                          <td>  <a href="apagarAcesso.php?id_auth=<?php echo $linha["id_auth"] ?>&acao=apagar">
                                                  <img src="../assets/remove.png" onclick="return confirm('Tem a certeza que deseja apagar? Lembre-se que não poderá recuperar estes registos')" width="25" height="25" title="Apagar o fiador">
                                                </a>
                                         </td>
